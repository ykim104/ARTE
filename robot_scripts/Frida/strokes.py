...
class Stroke(object):
    ...
    def __init__(self, trajectory=None):
        ...
        pass
    def paint(self, painter, x_start, y_start, rotation, step_size=.005, wait=False):
        ...
        for i in range(1, len(path)-1, 3):
            ...
            for t in np.linspace(0,1,n):
                ...
                #print("Stroke: ", x,y,z)
                painter.move_to(x_start+x, y_start+y, z, method='direct', speed=0.02, wait=False)
                #time.sleep(0.02)
            p0 = p3
    ...
    def get_rotated_trajectory(self, rotation):
        # Rotation in radians
        print("Get rotated trajectory: ", rotation)
...
def simple_parameterization_to_real(stroke_length, bend, z, alpha=0):
    ...
    #print(stroke_length, bend, alpha, z)
