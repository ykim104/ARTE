...
class Options():
    ...
    def initialize(self, parser):
        ...
        # TOOD: Add human-in-the-loop RL by Yejin
        parser.add_argument('--feedback', default=False, type=bool, help='request feedback from user during training')
        parser.add_argument('--feedback_type', default='corrective', choices=['corrective', 'evaluative'])
        parser.add_argument('--feedback_interval', default=20, type=int, help='episode interval to request feedback')
        ...
        parser.add_argument('--output', default='./models/DRL', type=str, help='Path to directory to output models to')
        ...
        parser.add_argument('--loss_fcn', default='clip', choices=['gan', 'l2', 'l1', 'cm', 'cml1', 'l1_penalized', 'clip'])
        parser.add_argument('--canvas_color', default='black', choices=['white','black', 'none'])
        parser.add_argument('--brush_color', default='white', choices=['white','black', 'color'])
        parser.add_argument('--renderer', default='renderer.pkl', type=str, help='Filename of renderer used to paint')
        parser.add_argument('--dataset', default='mnist', choices=['mnist','celeba','pascal', 'sketchy', 'cats', 'all'])
        ...
        #parser.add_argument('--built_in_cm', default=False, type=bool, help='Build the content masking into the actor model')
        
        # TODO: Brush stroke color- fixed
