...
def canvas_to_global_coordinates(x,y,z, opt, robot='lite6'):
    ...
    '''
    if robot == 'lite6':
        x_new =  opt.CANVAS_POSITION[0] + x*opt.CANVAS_HEIGHT
        y_new =  opt.CANVAS_POSITION[1] - y*opt.CANVAS_WIDTH + 20
        z_new = z
