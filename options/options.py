...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--seed', default=1321, type=int, help='random seed')
        ...
        parser.add_argument('--brush_color', default='black', choices=['white','black', 'color'])
        parser.add_argument('--renderer', default='renderer.pkl', type=str, help='Filename of renderer used to paint')
        parser.add_argument('--dataset', default='pascal', choices=['mnist','celeba','pascal', 'sketchy', 'cats', 'all'])
