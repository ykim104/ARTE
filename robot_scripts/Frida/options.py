...
class Options(object):
    def __init__(self):
        ...
        self.CANVAS_WIDTH  = 508 #- 120 #0.5080 # 20" in mm
        self.CANVAS_HEIGHT = 406.4 #- 125 #0.4064 # 16" in mm
        ...
        self.HOVER_FACTOR = 25 #0.1


        # Number of cells to paint in x and y directions
        self.cells_x, self.cells_y = 5, 4 #4, 5
        ...
        self.MIN_FILL_IN_LENGTH = 2 #0.02
        self.MAX_FILL_IN_LENGTH = 6 #0.06
        self.MIN_FILL_IN_HEIGHT = 2 #0.02
        self.MAX_FILL_IN_HEIGHT = 4 #0.04
